...
class Inventory():
    ...
    def __init__(self, root):
        ...
        head_title = Label(self.root,text="Shipping System",bd=10, relief=GROOVE, font=("ariel", 20 , "bold"), bg="RED", fg="white")
        ...
        m_title=Label(Manage_Frame,text="Shipping Management", font=("", 20 , "bold"), bg="crimson", fg="white")
